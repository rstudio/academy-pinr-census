...
This week, you learned how to write for loops and practiced purrr. In this milestone, you'll continue writing functions to create plots showing temporal trends in demographic composition. You'll also recreate this Quarto report that calls the functions you've written: https://rstudio.github.io/academy-pinr-census/assets/acs-report.html

To learn more about the variables contained in the data set, refer to the data dictionary [here](https://rstudio.github.io/academy-pinr-census/assets/census_dictionary.html){target="_blank" rel="noopener noreferrer"}.
...
https://rstudio.github.io/academy-pinr-census/assets/acs-report.html
